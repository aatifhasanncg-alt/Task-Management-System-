        ...
        <div class="cn-wrap">
            ...
            <div style="display:flex;align-items:center;justify-content:center;gap:12px;
                ...
                <a href="?month=<?= $nextMonth ?><?= $filterStatus ? '&status=' . $filterStatus : '' ?>"
                    class="cn-btn cn-btn-out cn-btn-sm" <?= $nextMonth > $now->format('Y-m') ? 'style="opacity:.4;pointer-events:none;"' : '' ?>>
            ...
            <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:12px;margin-bottom:20px;">
                ...
                $statCards = [
                    ...
                    ['fa-clock', 'Not Started', $stats['not_started_count'] ?? 0, '#6b7280', '#f3f4f6'],
                    ['fa-spinner', 'WIP', $stats['wip_count'] ?? 0, '#3b82f6', '#eff6ff'],
                    ['fa-pause-circle', 'Holding', $stats['holding_count'] ?? 0, '#6b7280', '#f3f4f6'],
            ...
            <!-- Filters -->
            <div class="cn-panel mb-3" style="overflow:visible;">
                <div style="padding:12px 16px;display:flex;gap:10px;flex-wrap:wrap;align-items:center;">
                    ...
                    <!-- Status pills -->
                    <a href="?month=<?= $month ?><?= $filterClient ? '&client_id=' . $filterClient : '' ?>" style="font-size:.75rem;padding:.25rem .7rem;border-radius:99px;text-decoration:none;
                    ...
                    <?php if (!empty($clients)): ?>
                        ...
                        <select id="clientSelect" name="client_id" style="width:100%;">
                                ...
                                <div style="display:flex;align-items:center;justify-content:space-between;gap:12px;flex-wrap:wrap;">
                                    ...
                                    <div style="display:flex;align-items:center;gap:12px;flex-shrink:0;">
                                        ...
                                        <div style="display:flex;gap:6px;">
                                            ...
                                            <a href="office_log_edit.php?id=<?= $l['id'] ?>" class="cn-btn cn-btn-gold cn-btn-sm"
                                                title="Edit">
...
<script>
    ...
    new TomSelect(clientEl, {
        ...
        onChange: function(val) {
            var url = '?month=<?= $month ?><?= $filterStatus ? '&status='.$filterStatus : '' ?>&client_id=' + (val || '');
            window.location = url;
        }
    });
});
