                ...
                <div class="d-flex gap-2 mb-3 flex-wrap align-items-center">
                    ...
                    <?php if ($filterStatus): ?>
                        <span style="background:#f3f4f6;border-radius:99px;padding:.2rem .6rem;font-size:.75rem;">
                            ...
                            <a href="?<?= http_build_query(array_diff_key($_GET, ['status' => ''])) ?>"
                                style="color:#ef4444;margin-left:.3rem;">×</a>
                        </span>
                    <?php endif; ?>
                    <?php if ($filterPriority): ?>
                        <span style="background:#f3f4f6;border-radius:99px;padding:.2rem .6rem;font-size:.75rem;">
                            Priority: <?= ucfirst($filterPriority) ?>
                            <a href="?<?= http_build_query(array_diff_key($_GET, ['priority' => ''])) ?>"
                                style="color:#ef4444;margin-left:.3rem;">×</a>
                        </span>
                    <?php endif; ?>
                    <?php if ($filterDept): ?>
                        ...
                        <span style="background:#f3f4f6;border-radius:99px;padding:.2rem .6rem;font-size:.75rem;">
                            ...
                            <a href="?<?= http_build_query(array_diff_key($_GET, ['dept_id' => ''])) ?>"
                                style="color:#ef4444;margin-left:.3rem;">×</a>
                        </span>
                    <?php endif; ?>
                    <?php if ($search): ?>
                    ...
                    <?php if (isset($_GET['overdue'])): ?>
                        <span style="background:#fef2f2;color:#ef4444;border-radius:99px;padding:.2rem .6rem;font-size:.75rem;">
                            ⚠ Overdue only
                            <a href="?<?= http_build_query(array_diff_key($_GET, ['overdue' => ''])) ?>"
                                style="color:#ef4444;margin-left:.3rem;">×</a>
                        </span>
                    <?php endif; ?>
                </div>
                            ...
                            <?php foreach ($taskList as $t):
                                ...
                                <tr <?= $isOverdue ? 'style="background:#fef2f2;"' : '' ?>>
                                    ...
                                    white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">
                                            ...
                                            <?php if ($t['company_name']): ?>
                                                <div style="font-size:.72rem;color:#9ca3af;">
                                                    <i
                                                        class="fas fa-building me-1"></i><?= htmlspecialchars($t['company_name']) ?>
                                                </div>
                                            <?php endif; ?>
                                        </div>
                                    </td>
                                 ...
                                 padding:.2rem .55rem;border-radius:99px;">
                                    ...
                                    <td
                                        style="font-size:.82rem;<?= $isOverdue ? 'color:#ef4444;font-weight:600;' : 'color:#6b7280;' ?>">
