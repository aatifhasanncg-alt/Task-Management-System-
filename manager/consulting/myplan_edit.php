<?php
/**
 * consulting/admin/plan_edit.php — admin: Edit Weekly Work Plan
 */
    ...
    if (!$errors) {
        ...
        try {
            ...
            try {
                ...
                $planUrl = APP_URL . '/executive/consulting/plan_view.php?id=' . $planId;
            ...
            <div class="page-hero mb-4">
                <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                    ...
                    <div class="d-flex gap-2 flex-wrap align-items-center">
                        <a href="my_plans.php?month=<?= $month ?>" class="btn btn-sm btn-outline-secondary">
                            <i class="fas fa-list me-1"></i> My Plans
                        </a>
                        <a href="myplan_view.php?id=<?= $planId ?>" class="btn btn-sm btn-outline-secondary">
                    ...
                    <div>
                        ...
                        <div class="cn-panel">
                            ...
                            <div style="padding:14px 16px;display:flex;flex-direction:column;gap:8px;">
                                <button type="submit" id="updatePlanBtn" class="cn-btn cn-btn-gold"
                                    style="justify-content:center;">
                                    <span id="updatePlanBtnIcon"><i class="fas fa-save"></i> Update Plan</span>
                                    <span id="updatePlanBtnLoading"
...
`;
    ...
    document.getElementById('editForm').addEventListener('submit', function () {
        ...
        document.getElementById('updatePlanBtnIcon').style.display = 'none';
        document.getElementById('updatePlanBtnLoading').style.display = 'inline-flex';
    });
</script>
