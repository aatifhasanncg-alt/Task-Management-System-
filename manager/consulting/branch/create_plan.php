<?php
/**
 * consulting/manager/branch/plan_create.php — Manager: Create Plan for a Staff Member
 */
...
// ── Staff list ────────────────────────────────────────────────
$conBranchFilterU2  = $isBranchManager ? "AND u2.branch_id = {$branchId}" : "";
$conBranchFilterUda = $isBranchManager ? "AND u4.branch_id = {$branchId}" : "";
...
$staffList = $db->query("
    ...
    WHERE u.is_active = 1
      AND (
            ...
            -- Users from CON department (branch-manager scoped to own branch)
            OR u.id IN (
                SELECT u2.id
                FROM users u2
                JOIN departments d 
