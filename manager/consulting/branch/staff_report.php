<?php
/**
 * /manager/consulting/branch/staff_report.php — Performance Reports
...
// Only this narrow subtype gets locked to their own branch; regular
// managers keep the existing exec/admin-equivalent broad access.
...
<div class="card-mis mb-4">
    <div class="card-mis-body" style="padding:.75rem 1rem;">
        <div class="row g-2 align-items-end">
            ...
            <?php if (($isExecutive || $isAdmin || $isManager) && !$isBranchManager): ?>
                <div class="col-md-2">
                ...
                <div class="col-md-2">
                    ...
                    <div style="font-size:.82rem;font-weight:600;color:#c9a84c;padding:.35rem 0;">
                        ...
                        <?php foreach ($branches as $b) if ($b['id'] == $branchId) echo htmlspecialchars($b['branch_name']); ?>
                    </div>
                </div>
            <div class="col-md-3">
