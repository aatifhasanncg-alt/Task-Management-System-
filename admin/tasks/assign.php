...
<script>
    ...
    // ADD inside the existing <script> block (the bindCounter function plus this call):
...
document.getElementById('assignForm').addEventListener('submit', function (e) {
    ...
    // department_id may be a <select> (executive/cross-dept/multi-dept) or a hidden input (locked single dept)
    ...
    // branch_id may be a <select> or a hidden input (locked)
