...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['edit_company'])) {
    ...
    if (!$fields['company_name']) {
        ...
        $db->prepare("
            ...
            WHERE id=?
        ")->execute([
            $fields['company_name'], $fields['company_code'], $fields['pan_number'],
            $fields['reg_number'],   $fields['return_type'],  $fields['contact_person'],
            $fields['contact_phone'],$fields['contact_email'],$fields['address'],
            $fields['branch_id'],    $fields['company_type_id'], $fields['industry_id'],
            $id
        ]);
        ...
        <div style="padding:1.5rem 0;">
            ...
            <div class="d-flex align-items-center justify-content-between mb-3 flex-wrap gap-2">
                ...
                <div class="d-flex gap-2">
                    <!-- Edit button — everyone can edit company details -->
                            ...
                            <div style="border:1px solid #f3f4f6;border-radius:10px;
                                ...
                                <div class="row g-2">
                                    ...
                                    <div class="col-md-3 col-6">
                                        <div style="font-size:.68rem;font-weight:700;color:#9ca3af;text-transform:uppercase;">
                                            <?= $label ?>
                                        </div>
                        ...
                        <form method="POST" id="editCompanyForm">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="return_type" class="form-control form-control-sm"
                                           value="<?= htmlspecialchars($company['return_type'] ?? '') ?>">
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <select name="branch_id" class="form-select form-select-sm">
                                        <?php foreach ($allBranches as $b): ?>
                                            <option value="<?= $b['id'] ?>"
                                                <?= $company['branch_id']==$b['id']?'selected':'' ?>>
