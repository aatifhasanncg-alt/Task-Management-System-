                    ...
                    <div class="card-mis mb-4">
                        <div class="card-mis-header">
                            <div class="d-flex align-items-center gap-3">
                                <div
                                    style="width:48px;height:48px;border-radius:10px;background:#0a0f1e;color:#c9a84c;display:flex;align-items:center;justify-content:center;font-weight:700;font-size:1rem;flex-shrink:0;">
                                    <?= strtoupper(substr($company['company_name'], 0, 2)) ?>
                                </div>
                                <div>
                                    <h5 style="margin:0;font-size:1rem;">
                                        <?= htmlspecialchars($company['company_name']) ?></h5>
                        ...
                        <div class="table-responsive">
                            <table class="table-mis w-100">
                                ...
                                <tbody>
                                    <?php if (empty($tasks)): ?>
                                        <tr>
                                            <td colspan="8" class="empty-state"><i class="fas fa-list-check"></i>No tasks
                                                yet</td>
                                        </tr>
                                    <?php endif; ?>
                                    <?php foreach ($tasks as $t):
                                        ...
                                        <tr <?= $overdue ? 'style="background:#fef2f2;"' : '' ?>>
                                            ...
                                            <td>
                                                <span
                                                    style="font-size:.75rem;background:<?= htmlspecialchars($t['color'] ?? '#ccc') ?>22;color:<?= htmlspecialchars($t['color'] ?? '#666') ?>;padding:.2rem .5rem;border-radius:99px;">
                                                    <?= htmlspecialchars($t['dept_name'] ?? '—') ?>
                                                </span>
                                            </td>
                                            <td style="font-size:.82rem;">
                                                <?= htmlspecialchars($t['assigned_to_name'] ?? '—') ?></td>
                                            <td><span
                                    ...
                                    <div style="border:1px solid #f3f4f6;border-radius:10px;padding:1rem;margin-bottom:1rem;">
                                        <div class="d-flex justify-content-between align-items-center mb-3">
                                            <div>
                                                ...
                                                <span
                                                    style="font-size:.82rem;color:#6b7280;margin-left:.5rem;"><?= htmlspecialchars($r['title']) ?></span>
                                            </div>
                                        </div>
                                        <div class="row g-2">
                                            <?php
                            ...
                            <div class="card-mis-body">
                                <div style="position:relative;padding-left:1.5rem;">
                                    <?php foreach ($workflow as $w): ?>
                                        <div
                                            style="position:relative;margin-bottom:1.2rem;padding-left:1rem;border-left:2px solid #f3f4f6;">
                                            <div
                                            ...
                                            <div
                                                ...
                                                <span class="task-number ms-1"
                                                    style="font-size:.7rem;"><?= htmlspecialchars($w['task_number']) ?></span>
                                            </div>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="card-mis mb-3 p-3" style="font-size:.82rem;color:#6b7280;">
                        <div class="mb-2"><strong>Code:</strong>
                            <?= htmlspecialchars($company['company_code'] ?? '—') ?></div>
                        <div class="mb-2"><strong>PAN:</strong> <?= htmlspecialchars($company['pan_number'] ?? '—') ?>
                        </div>
                        <div class="mb-2"><strong>Reg #:</strong> <?= htmlspecialchars($company['reg_number'] ?? '—') ?>
                        </div>
