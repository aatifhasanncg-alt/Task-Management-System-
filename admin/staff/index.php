...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    header('Location: ../users/view.php?id=' . $_POST['user_id']);
    exit;
}
                ...
                <form method="GET" class="row g-2 align-items-end w-100">
                    <div class="col-md-4">
                        ...
                        <input type="text" name="search" class="form-control form-control-sm"
                            placeholder="Name, email, employee ID, phone..." value="<?= htmlspecialchars($search) ?>">
                    </div>
                    <?php if (isExecutive()): ?>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-4 col-lg-3">
                            <div class="card-mis h-100" style="padding:0;">
                                <div style="padding:1.25rem;">
                                    ...
                                    <div class="d-flex align-items-center gap-3 mb-3">
                                        ...
                                        <div style="min-width:0;">
                                            <div
                                                style="font-size:.88rem;font-weight:600;color:#1f2937;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">
                                    ...
                                    <!-- Task stats -->
                                    <div
                                        style="background:#f9fafb;border-radius:8px;padding:.6rem .75rem;display:flex;gap:.75rem;">
                                        <div style="text-align:center;flex:1;">
                                            <div style="font-size:1.1rem;font-weight:700;color:#f59e0b;"><?= $s['open_tasks'] ?>
                                            </div>
                                            <div style="font-size:.65rem;color:#9ca3af;">Open</div>
                                        </div>
                                        <div style="width:1px;background:#e5e7eb;"></div>
                                        <div style="text-align:center;flex:1;">
                                            <div style="font-size:1.1rem;font-weight:700;color:#10b981;"><?= $s['done_tasks'] ?>
                                            </div>
                                ...
                                <div style="border-top:1px solid #f3f4f6;padding:.65rem 1.25rem;display:flex;gap:.5rem;">
                                    ...
                                    <a href="view.php?id=<?= $s['id'] ?>" class="btn btn-sm btn-gold flex-grow-1"
