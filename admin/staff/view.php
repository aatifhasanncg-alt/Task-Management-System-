...
if (!$staff) { setFlash('error', 'Staff not found.'); header('Location: index.php'); exit; }
...
if (!isExecutive()) {
    ...
    if ($staff['branch_id'] != $adminUser['branch_id'] || 
...
<div class="d-flex align-items-center justify-content-between mb-3 flex-wrap gap-2">
    ...
    <a href="<?= APP_URL ?>/admin/tasks/assign.php?assigned_to=<?= $id ?>"
...
<div class="row g-4">
    ...
    <div class="col-lg-8">
        ...
        <div class="card-mis mb-4">
            <div class="card-mis-header">
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        <h5 style="margin:0;font-size:1rem;"><?= htmlspecialchars($staff['full_name']) ?></h5>
                ...
                <span style="background:<?= htmlspecialchars($staff['dept_color'] ?? '#ccc') ?>22;color:<?= htmlspecialchars($staff['dept_color'] ?? '#666') ?>;font-size:.75rem;padding:.3rem .7rem;border-radius:99px;">
        ...
        <div class="card-mis mb-4">
            <div class="card-mis-header">
                <h5><i class="fas fa-chart-bar text-warning me-2"></i>Monthly Performance (Last 6 Months)</h5>
            </div>
            <div class="card-mis-body">
        ...
        <div class="card-mis mb-4">
            <div class="card-mis-header">
                <h5><i class="fas fa-list-check text-warning me-2"></i>Assigned Tasks (<?= $totalTasks ?>)</h5>
            </div>
            <div class="table-responsive">
                <table class="table-mis w-100">
                    ...
                    <tbody>
                    <?php if (empty($tasks)): ?>
                        <tr><td colspan="7" class="empty-state"><i class="fas fa-list-check"></i>No tasks assigned</td></tr>
                    <?php endif; ?>
        ...
        <div class="card-mis mb-4">
            <div class="card-mis-header">
                <h5><i class="fas fa-check-double text-warning me-2"></i>Retail Tasks Finalised by This Staff</h5>
            </div>
            <div class="table-responsive">
                <table class="table-mis w-100">
                    <thead>
                    ...
                    <?php foreach ($finalisedTasks as $f): ?>
                        <tr>
                            <td><span class="task-number"><?= htmlspecialchars($f['task_number']) ?></span></td>
                            <td style="font-size:.87rem;max-width:160px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">
    ...
    <div class="col-lg-4">
        ...
        <div class="card-mis mb-3">
            ...
            <div class="card-mis-body">
                ...
                <div class="row g-2 mb-3">
                    ...
                    <div class="col-6">
                        <div style="background:<?= $bg ?>;border-radius:10px;padding:.75rem;text-align:center;">
                            <i class="fas <?= $icon ?>" style="color:<?= $color ?>;font-size:1.1rem;"></i>
                            <div style="font-size:1.4rem;font-weight:700;color:<?= $color ?>;line-height:1.2;margin-top:.2rem;"><?= $val ?></div>
                ...
                ?>
                <div style="border-top:1px solid #f3f4f6;padding-top:1rem;margin-top:.5rem;text-align:center;">
        ...
        <div class="card-mis p-3" style="font-size:.82rem;color:#6b7280;">
            ...
            <div><strong>Last Login:</strong> <?= $staff['last_login'] ? date('d M Y, H:i', strtotime($staff['last_login'])) : 'Never' ?></div>
        </div>
