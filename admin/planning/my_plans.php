...
@media (max-width: 768px) {
    ...
    .cn-wrap { padding: 0 10px !important; }
    .plan-hero-actions { flex-direction: column !important; align-items: stretch !important; }
    .plan-hero-actions .form-control,
    .plan-hero-actions .btn { width: 100% !important; }
}
@media (max-width: 480px) {
    .kpi-row { grid-template-columns: repeat(2, 1fr) !important; }
    .kpi-val  { font-size: 1.2rem !important; }
    .kpi-tile { padding: 10px 8px !important; }
    .kpi-label { font-size: .65rem !important; }
    .kpi-icon  { font-size: .9rem !important; }
}
...
@media (max-width: 360px) {
    ...
    .plan-card-footer .cn-btn,
    .plan-card-footer form { flex: unset; width: 100%; }
}
                ...
                <div style="background:#fff;border-radius:12px;border:1.5px solid #f1f5f9;
                    ...
                    <div style="padding:14px 16px 10px;display:flex;justify-content:space-between;
                        ...
                        <span class="plan-status-badge"
                              style="background:<?= $sc2[$st] ?>;color:<?= $sc[$st] ?>;">
                            <?= $st ?>
                        </span>
                    </div>
                    ...
                    <div class="plan-card-footer">
                        <a href="myplan_view.php?id=<?= $p['id'] ?>"
                           class="cn-btn cn-btn-gold cn-btn-sm"
                           style="justify-content:center;">
                            <i class="fas fa-eye"></i> View
                        </a>
                        <a href="myplan_edit.php?id=<?= $p['id'] ?>"
                        ...
                        <form method="POST" action="plan_submit.php"
                              onsubmit="return confirm('Submit this plan for approval?')">
