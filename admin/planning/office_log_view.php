<?php
/**
 * consulting/staff/office_log_view.php — Staff: View Office Work Log
 */
...
// 👇 Restrict ONLY if NOT admin/supervisor
if (!in_array($role, ['admin'])) {
    $query .= " AND owl.user_id = ?";
    $params[] = $uid;
}
                ...
                <div>
                    ...
                    <div class="cn-panel mb-3">
                        ...
                        <div style="padding:14px 16px;display:flex;flex-direction:column;gap:8px;">
                            ...
                            <a href="log_list.php?month=<?= $month ?>&log_type=office" class="cn-btn cn-btn-out"
                                style="justify-content:center;">
