                        ...
                        <div style="padding:14px 20px;display:flex;align-items:center;gap:14px;">
                            ...
                            <div>
                                <div style="font-size:.92rem;font-weight:700;color:#1f2937;">
                                    ...
                                    <?php if ($isOwnLog): ?>
                                    <span style="font-size:.65rem;background:#fef3c7;color:#d97706;
                    ...
                    <div class="cn-panel mb-3">
                        ...
                        <div style="padding:18px 20px;">
                            <div class="row g-4">
                                ...
                                <div class="col-md-6">
                                    <div style="font-size:.7rem;font-weight:700;color:#9ca3af;text-transform:uppercase;letter-spacing:.05em;margin-bottom:5px;">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div style="font-size:.75rem;color:#6b7280;margin-top:2px;">
                                        <?= $log['day_of_week'] ?> · Week <?= $log['week_number'] ?> · <?= date('F Y', strtotime($log['log_date'])) ?>
                                    </div>
                                </div>
                            ...
                            <div style="display:flex;align-items:center;gap:14px;flex-wrap:wrap;">
                                ...
                                <div>
                                    <div style="font-size:.82rem;font-weight:700;color:#1f2937;">
                                        Week <?= $planEntry['week_number'] ?> · <?= date('d M Y', strtotime($planEntry['plan_date'])) ?>
                                    </div>
                ...
                <div>
                    ...
                    <div class="cn-panel mb-3">
                        ...
                        <div style="padding:16px;">
                            <div style="text-align:center;background:#fffbeb;border-radius:12px;
                                ...
                                <div style="font-size:.72rem;color:#9ca3af;margin-top:4px;font-weight:600;">HOURS ON SITE</div>
                    ...
                    <div class="cn-panel mb-3">
                        ...
                        <div style="padding:14px 16px;display:flex;flex-direction:column;gap:8px;">
                            ...
                            <a href="office_log_list.php?month=<?= $month ?>"
                               class="cn-btn cn-btn-out" style="justify-content:center;">
