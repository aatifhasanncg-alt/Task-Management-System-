<!-- // includes/technical_support_report.php -->
<?php
...
// Always show only issues raised by the logged-in user
$where[] = "ti.token_raiser_id = ?";
$params[] = $uid;
...
// ── Task statuses (for filter dropdown) ───────────────────────────────────────
    ...
    <div style="padding:1.5rem 0;">
        <div class="page-hero d-flex justify-content-between align-items-center flex-wrap gap-2">
            <div>
                ...
                <h4 class="mb-1">My Raised Issues</h4>
                <p class="mb-0" style="color:#6b7280;"><?= count($issues) ?> total</p>
            </div>
            <a href="technical_support.php" class="btn btn-gold btn-sm"><i class="fas fa-plus me-1"></i>Raise Issue</a>
        </div>
                ...
                <tbody>
                    <?php foreach ($issues as $i): ?>
                        <tr>
                            ...
                            <td><a href="issue_view.php?id=<?= $i['id'] ?>"
