...
if (!$profile) { echo "User profile not found!"; exit; }
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && ($_POST['action'] ?? '') === 'change_password') {
    ...
    if (!password_verify($currentPw, $profile['password']))  $errors[] = 'Current password is incorrect.';
    if (strlen($newPw) < 8)                                  $errors[] = 'New password must be at least 8 characters.';
    if (!preg_match('/[A-Z]/', $newPw))                      $errors[] = 'Password must contain at least one uppercase letter.';
    if (!preg_match('/[0-9]/', $newPw))                      $errors[] = 'Password must contain at least one number.';
    ...
    <div class="col-lg-4">
        ...
        <div class="card-mis text-center mb-4">
            <div class="card-mis-body py-4">
                ...
                <h5 style="font-size:1.1rem;font-weight:700;"><?= htmlspecialchars($profile['full_name']) ?></h5>
                <p style="color:#9ca3af;font-size:.83rem;margin:.25rem 0;"><?= htmlspecialchars($profile['email']) ?></p>
                ...
                <?php endif; ?>
                <div class="mt-3">
                    <span style="background:#fef3c7;color:#92400e;font-size:.72rem;padding:.25rem .75rem;border-radius:99px;font-weight:600;text-transform:uppercase;">
                        <i class="fas fa-user-shield me-1"></i><?= htmlspecialchars($profile['role_name'] ?? 'Admin') ?>
                    </span>
                </div>
            </div>
        </div>
        ...
        <div class="card-mis mb-4">
            ...
            <div class="card-mis-body">
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        <div style="font-size:.72rem;font-weight:700;color:#9ca3af;text-transform:uppercase;letter-spacing:.06em;">
                    ...
                    <div class="row g-3">
                        <div class="col-md-12">
                            ...
                            <div style="position:relative;">
                                <input type="password" id="cp" name="current_password" class="form-control" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <div style="position:relative;">
                                <input type="password" id="cp2" name="confirm_password" class="form-control" required>
                        ...
                        <div class="col-12">
                            <div class="d-flex gap-3 flex-wrap" style="font-size:.78rem;">
                                <span id="r-len"><i class="fas fa-circle" style="font-size:.5rem;"></i> 8+ characters</span>
                                <span id="r-upper"><i class="fas fa-circle" style="font-size:.5rem;"></i> Uppercase</span>
                                <span id="r-lower"><i class="fas fa-circle" style="font-size:.5rem;"></i> Lowercase</span>
                                <span id="r-num"><i class="fas fa-circle" style="font-size:.5rem;"></i> Number</span>
                            </div>
                        </div>
                    </div>
                    <div class="mt-4">
