<?php
/**
 * executive/consulting/plan_approval.php — Executive: Approve/Reject Work Plans
 */
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($planId && in_array($action, ['approve', 'reject', 'bulk_approve'])) {
        ...
        if ($action === 'bulk_approve') {
            ...
            if (!$remarks) {
                ...
                header('Location: plan_approval.php?month=' . $month . '&staff_id=' . $staffId . '&status=' . $statusFilter);
                exit;
            }
            $db->prepare("
                UPDATE work_plans 
    ...
    header('Location: plan_approval.php?month=' . $month . '&staff_id=' . $staffId . '&status=' . $statusFilter . '&week=' . $weekFilter);
    exit;
}
...
<style>
.status-tab { display:inline-flex;align-items:center;gap:5px;padding:4px 12px;border-radius:20px;
    font-size:.75rem;font-weight:600;cursor:pointer;border:1.5px solid #e5e7eb;
        ...
        <div class="cn-wrap">
            ...
            <div class="page-hero mb-4">
                <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                    <div>
                        <div class="page-hero-badge"><i class="fas fa-check-circle"></i> Executive · Consulting</div>
            ...
            <form method="GET" style="background:#f9fafb;border-radius:10px;padding:12px 14px;
                ...
                <a href="plan_approval.php" class="cn-btn cn-btn-out cn-btn-sm">
