                                    ...
                                    <div class="col-6 col-md-4">
                                        <div style="background:#f9fafb;border-radius:8px;padding:.7rem .85rem;">
                                            <div style="font-size:.68rem;color:#9ca3af;margin-bottom:.2rem;">
                                                <i class="fas <?= $ico ?>"
                                                    style="color:<?= $col ?>;margin-right:.3rem;"></i><?= $lbl ?>
                                            </div>
                    ...
                    <div class="card-mis mb-3">
                        ...
                        <div class="card-mis-body">
                            ...
                            <div style="margin-top:.75rem;">
                                <div
                                    style="display:flex;justify-content:space-between;font-size:.75rem;margin-bottom:.3rem;">
                                ...
                                <div style="background:#f3f4f6;border-radius:99px;height:7px;overflow:hidden;">
                                    <div
                                        style="width:<?= $visitEff ?>%;background:<?= $effColor ?>;height:100%;border-radius:99px;transition:.4s;">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-mis">
                            ...
                            <div class="card-mis-body">
                                ...
                                <form method="POST" style="margin-bottom:.6rem;">
                                    ...
                                    <button type="submit" onclick="return confirm('Approve this plan?')" style="width:100%;padding:.55rem;background:#10b981;color:#fff;border:none;
                           ...
                           border-radius:8px;font-weight:700;font-size:.82rem;cursor:pointer;">
                                ...
                                <div id="rejectBox" style="display:none;margin-top:.75rem;">
                                   ...
                                   margin-bottom:.5rem;"></textarea>
                                        <button type="submit" onclick="return confirm('Reject this plan?')" style="width:100%;padding:.5rem;background:#ef4444;color:#fff;border:none;
                    ...
                    <table class="table-mis w-100">
                        ...
                        <tbody>
                            <?php if (empty($entries)): ?>
                                <tr>
                                    <td colspan="12" style="text-align:center;padding:24px;color:#9ca3af;font-size:.83rem;">
                            ...
                            <?php foreach ($entries as $i => $e):
                                ...
                                <tr <?= $rowBg ?>>
                                    ...
                                    <td class="text-center">
                                        <span
                                            style="font-weight:600;color:#3b82f6;"><?= number_format((float) $e['planned_hours'], 1) ?>h</span>
                                    </td>
                                    <td class="text-center">
                                        <?php if ($isMatched): ?>
                                            <span
                                                style="font-weight:700;color:<?= (float) $e['logged_hours'] >= 4 ? '#10b981' : ((float) $e['logged_hours'] >= 2 ? '#f59e0b' : '#ef4444') ?>;">
                                    ...
                                    <td class="text-center">
                                        <?php if ($isMatched): ?>
                                            <span
                                                style="background:#ecfdf5;color:#10b981;padding:.15rem .5rem;border-radius:99px;font-size:.7rem;font-weight:600;">
                                                <i class="fas fa-check" style="font-size:.6rem;"></i> Logged
                                            </span>
                                        <?php else: ?>
                                            <span
                                                style="background:#fef2f2;color:#ef4444;padding:.15rem .5rem;border-radius:99px;font-size:.7rem;font-weight:600;">
                        ...
                        <?php if (!empty($entries)): ?>
                            <tfoot>
                                <tr style="background:#f9fafb;font-weight:700;">
                                    ...
                                    <td class="text-center" style="color:#3b82f6;"><?= number_format($totalPlannedH, 1) ?>h
                                    </td>
                                    <td class="text-center" style="color:#c9a84c;"><?= number_format($totalActualH, 1) ?>h
                                    </td>
                                    <td class="text-center" style="color:#10b981;"><?= $matchedCount ?>/<?= $totalEntries ?>
                                    </td>
                                    <td colspan="2"></td>
                                </tr>
                            </tfoot>
