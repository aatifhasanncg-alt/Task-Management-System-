...
if ($staffId)
    $kpiWhere .= " AND wl.user_id={$staffId}";
if ($clientId)
    $kpiWhere .= " AND wl.client_id={$clientId}";
if ($vstatus)
    $kpiWhere .= " AND wl.visit_status='" . $db->quote($vstatus) . "'";
            ...
            <form method="GET" class="filter-bar">
                ...
                <div style="display:flex;align-items:center;gap:6px;">
                    ...
                    <select name="vstatus" class="cn-input" style="width:130px;">
                        ...
                        <option value="rescheduled" <?= $vstatus === 'rescheduled' ? 'selected' : '' ?>>🔄 Rescheduled
                        </option>
                    </select>
                </div>
                <div style="display:flex;align-items:center;gap:6px;">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div style="font-weight:600;font-size:.82rem;">
                                                <?= htmlspecialchars($l['full_name']) ?></div>
                                            <div style="font-size:.68rem;color:#9ca3af;">
                                                <?= htmlspecialchars($l['employee_id'] ?? '') ?></div>
                                        </td>
                                        <td>
                                            <div style="font-weight:600;font-size:.82rem;">
                                                <?= htmlspecialchars($l['company_name']) ?></div>
                                            <div style="font-size:.68rem;color:#9ca3af;">
