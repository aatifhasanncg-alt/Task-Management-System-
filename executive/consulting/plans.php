        ...
        <div class="cn-wrap">
            ...
            <form method="GET" class="filter-bar">
                ...
                <div style="margin-left:auto;display:flex;gap:6px;">
                    <a href="<?= APP_URL ?>/exports/export_excel.php?module=consulting_performance&view=monthly&month=<?= urlencode($month) ?>&staff_id=<?= $staffId ?>&status=<?= urlencode($status) ?>"
                        class="cn-btn cn-btn-out cn-btn-sm">
                        <i class="fas fa-file-excel" style="color:#10b981;"></i> Excel
                    </a>
                    <a href="<?= APP_URL ?>/exports/export_pdf.php?module=consulting_performance&view=monthly&month=<?= urlencode($month) ?>&staff_id=<?= $staffId ?>&status=<?= urlencode($status) ?>"
                        class="cn-btn cn-btn-out cn-btn-sm">
...
<div id="rejectModal"
    ...
    <div
        style="background:#fff;border-radius:12px;padding:24px;width:400px;max-width:90vw;box-shadow:0 20px 60px rgba(0,0,0,.2);">
        <div style="font-weight:700;font-size:.95rem;margin-bottom:4px;"><i
                class="fas fa-times-circle text-danger me-2"></i>Reject Plan</div>
